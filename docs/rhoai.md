...
2) Go to the `Data Science Projects` section and access your application's project named `chatbot1-may7-3`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot1-may7-3-notebook`.
...
5) In the terminal, run `cd chatbot1-may7-3` to navigate to your sample app's directory.
